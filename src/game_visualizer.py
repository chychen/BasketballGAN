...
def plot_data(data, length, file_path=None, if_save=False, fps=6, dpi=128):
    ...
    anim = animation.FuncAnimation(
        fig,
        update_all,
        fargs=(player_circles, ball_circle, annotations, data),
        frames=length,
        interval=100)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--save', type=bool, default=True, help='bool, if save as gif file')
    parser.add_argument(
        '--amount',
        type=int,
        default=100,
    ...
    parser.add_argument(
        '--seq_length', type=int, default=100, help='how long for each event')
    parser.add_argument(
        '--save_path',
        type=str,
        default='../../data/',
